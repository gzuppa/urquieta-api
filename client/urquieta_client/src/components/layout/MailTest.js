...
const MailTest = () => {
   ...
   const handleSubmit = e =>{
	    e.preventDefault();
	   	emailjs.send('default_service','template_4d6nros', contact, 'user_usHOEfGEmch3oBFrgqNCY')
		.then((response) => {
  ...
  return (
    <div className="container pt-2 text-center">
		<div className="alert alert-light" role="alert">
		  <a href="https://tupaginaonline.net/tutorial-para-enviar-correo-con-react-js-hooks-y-emailjs">Pruebas de mailing</a>
		</div>
